  ...
  return (
    <section className="py-20 text-center h-full">
      <div className="mx-auto">
        ...
        <h1 className="text-3xl mb-5 md:text-8xl font-bold text-primary max-w-full mx-auto leading-tight font-primary">
          Put your money
          <br />
          Where your mouth is
        </h1>

        <p className="md:text-lg text-xs md:mb-6 mb-2 md:text-md text-muted-foreground md:w-full w-64 mx-auto font-primary">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 mt-32 bg-[#F5F5F5] w-full h-52 md:h-24">
